...
public class HR_EmployeesPage extends BaseClass{
	...
	@FindBy(xpath="//div[@class='order-xl-2 mb-5 mb-xl-0 d-flex col']//button[text()='Add Employee']")WebElement btn_AddEmployee;
	
	@FindBy(id="input-name")WebElement txt_empName;
	@FindBy(xpath="//input[@id='input-name']") WebElement edit_empName;
	
	@FindBy(id="input-number")WebElement txt_empNumber;
	@FindBy(xpath="//input[@id='input-number']") WebElement edit_empNumber;
	
	@FindBy(id="input-mail")WebElement txt_empMail;
	
	@FindBy(id="input-birthday")WebElement date_empDOB;
	
	@FindBy(xpath="//select[@name='role']")WebElement dd_empRole;
	
	@FindBy(name="department")WebElement dd_empDepartment;
	
	@FindBy(name="doj")	WebElement date_empDOJ;
	
	@FindBy(name="salary")WebElement txt_empSalary;
	
	@FindBy(xpath="//input[@accept='image/*']")	WebElement file_uploadImage;
	
	@FindBy(name="password")WebElement txt_empPassword;
	
	@FindBy(name="address")	WebElement txt_empLocation;
	
	@FindBy(xpath="//button[text()='Submit']")WebElement btn_Submit;
	
	@FindBy(xpath="(//div[@class='dropleft dropdown'])[last()]")WebElement dropleftDropdown_last;
	
	@FindBy(xpath="(//button[text()='Edit'])[last()]")WebElement edit_last;
	
	@FindBy(xpath="(//button[text()='Delete'])[last()]")WebElement delete_last;
	
	@FindBy(xpath="//p[text()='Employee added successfully!']")WebElement msg_success;
	
	@FindBy(xpath="//button[text()='OK']") WebElement btn_OK;
	
	@FindBy(xpath="//p[text()='Employee updated successfully!']") WebElement msg_updateSuccess;
	
	@FindBy(xpath="//button[contains(text(), 'Yes,')]") WebElement btn_deleteConfirm;
	
	@FindBy(xpath="//button[text()='No']") WebElement btn_NO;
	
	@FindBy(xpath="//button[text()='Back']") WebElement btn_back;
