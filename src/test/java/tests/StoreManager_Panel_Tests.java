...
public class StoreManager_Panel_Tests extends BaseClass{
    ...
    //Store Manager can open Vendor List and see vendor cards with name, email, phone, avatar, and a View More link.
    @Test
	...
	//Store Manager can edit vendor details from the 3-dot (kebab) menu on the card.
	@Test
	...
	//Store Manager can click “Add Stock” to receive items from a Vendor into Store.
    @Test
    ...
    //Data matches the movements from Vendor to Store, Vendor Material Delivery, Vendor Material Return, Store to Vendor.
    @Test
   ...
   //Store Manager can click “Add New Waste” to record a waste item (product, qty, reason, date, location/project, disposal method, notes, attachment).
    @Test
    ...
    //Store Manager can record a replacement item for a specific waste (link to the waste record).
   @Test
